...
class ReacherWrapper(gym.Wrapper):
    def __init__(self, tol, image_shape=(0, 0, 0), image_period=None, reward_scale=1.0, use_ground_truth=False, chw=True):
        ...
        if image_shape != (0, 0, 0):
            if chw:
                ...
                self._image_buffer = deque([], maxlen=image_shape[-1]//3)
