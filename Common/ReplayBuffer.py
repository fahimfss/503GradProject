## ReplayBuffer code from https://github.com/rlai-lab/relod/blob/main/relod/algo/sac_rad_buffer.py
...
class AsyncReplayBuffer(ReplayBuffer):
    def __init__(self, image_shape, proprioception_shape, action_shape, capacity, batch_size,
        ...
        super(AsyncReplayBuffer, self).__init__(image_shape, proprioception_shape, action_shape, capacity, batch_size)
