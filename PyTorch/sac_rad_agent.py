...
from sac_rad_buffer import AsyncRadReplayBuffer, RadReplayBuffer
from rl_agent import BaseLearner, BasePerformer
...
class SACRADLearner(BaseLearner):
    ...
    def _update(self, images, propris, actions, rewards, next_images, next_propris, dones):
        ...
        if self._num_updates % 100 == 0:
            print("Update {} took {:.4f}s to update the model".format(self._num_updates, diff))
        stats['train/update_time'] = diff
        return stats
